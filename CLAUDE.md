...
| `src/lib/categoryIcons.ts` | Which Material glyph stands for a category, matched on the words in the user's own name; anything unrecognised gets the neutral `category` glyph. Pure and tested |
