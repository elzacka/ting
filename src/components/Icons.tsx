...
const paths = {
  ...
  // Ties a column to a category (Bruk bare i, også i, ikke i): a label, whatever the category
...
const symbolIcons: ReadonlySet<IconName> = new Set<IconName>(['autorenew', 'gridView'])
