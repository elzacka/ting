...
const paths = {
  ...
  editOff:
    'M12.126 8.125l1.937-1.937 3.747 3.747-1.937 1.938zM20.71 5.63l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75L20.71 7c.39-.39.39-1.02 0-1.37zM2 5l6.63 6.63L3 17.25V21h3.75l5.63-5.62L18.99 22 21 19.99 3.99 3 2 5z',
...
const symbolIcons: ReadonlySet<IconName> = new Set<IconName>(['autorenew'])
